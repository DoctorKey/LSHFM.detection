...
def get_coco():
    ...
    t = [ConvertCocoPolysToMask(), T.ToTensor(), T.RandomHorizontalFlip(0.5)]
    train_transforms = T.Compose(t)
    img_folder = os.path.join(root, "train2017")
    ann_file = os.path.join(root, "annotations", "instances_train2017.json")
    train_dataset = CocoDetection(img_folder, ann_file, transforms=train_transforms)
    ...
    test_dataset = CocoDetection(img_folder, ann_file, transforms=test_transforms)

    num_classes = 91
    # train_dataset: 117266
    # test_dataset: 5000
