...
CUDA_VISIBLE_DEVICES=$GPUS python -m torch.distributed.launch --master_port $PORT --nproc_per_node=4 --use_env \
	src/train.py --dataset voc0712 --model fasterrcnn_vgg11_with_vgg16 --epochs 24 --lr-steps 18 22 --lr 0.01 --lr-warmup 1000 \
	...
	--teacher-ckpt pretrained/voc0712_fasterrcnn_vgg16_78.4.ckpt \
	--distill lsh --beta 7 --bias 0